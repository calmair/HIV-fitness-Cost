...
fingernotes <-c("5UTR_nonsyn","Gag_nonsyn","Pol_nonsyn","Vif_nonsyn","Vpr_nonsyn","Vpu_nonsyn","Env_nonsyn","Nef_nonsyn")
OverviewDFZanini1<- OverviewDFZanini[1:634,1:10] #5UTR
...
AllA[(which(AllA$makesCpG == 1 & AllA$TypeOfSite == "nonsyn") ),11] <- mean(AllA$colMeansTsZanini[(which(AllA$makesCpG == 1 & AllA$TypeOfSite == "nonsyn") )])
AllA[(which(AllA$makesCpG == 0 & AllA$TypeOfSite == "nonsyn") ),11] <- mean(AllA$colMeansTsZanini[(which(AllA$makesCpG == 0 & AllA$TypeOfSite == "nonsyn") )])

print(mean(AllA$colMeansTsZanini[(which(AllA$makesCpG == 1 & AllA$TypeOfSite == "nonsyn") )]))
print(mean(AllA$colMeansTsZanini[(which(AllA$makesCpG == 0 & AllA$TypeOfSite == "nonsyn") )]))
...
AllT[(which(AllT$makesCpG == 1 & AllT$TypeOfSite == "nonsyn") ),11] <- mean(AllT$colMeansTsZanini[(which(AllT$makesCpG == 1 & AllT$TypeOfSite == "nonsyn") )])
AllT[(which(AllT$makesCpG == 0 & AllT$TypeOfSite == "nonsyn") ),11] <- mean(AllT$colMeansTsZanini[(which(AllT$makesCpG == 0 & AllT$TypeOfSite == "nonsyn") )])

print(mean(AllT$colMeansTsZanini[(which(AllT$makesCpG == 1 & AllT$TypeOfSite == "nonsyn") )]))
print(mean(AllT$colMeansTsZanini[(which(AllT$makesCpG == 0 & AllT$TypeOfSite == "nonsyn") )]))


AllC$graphit<-NA
for (i in 1:length(AllC$makesCpG)) {
  if (AllC$makesCpG[i] == 1 && AllC$TypeOfSite[i] == "nonsyn") {
    AllC$graphit[i] <- 2
  }
  if (AllC$makesCpG[i] == 0 && AllC$TypeOfSite[i] == "nonsyn") {
    AllC$graphit[i] <- 1
  }
}
AllC[(which(AllC$makesCpG == 1 & AllC$TypeOfSite == "nonsyn") ),11] <- mean(AllC$colMeansTsZanini[(which(AllC$makesCpG == 1 & AllC$TypeOfSite == "nonsyn") )])
AllC[(which(AllC$makesCpG == 0 & AllC$TypeOfSite == "nonsyn") ),11] <- mean(AllC$colMeansTsZanini[(which(AllC$makesCpG == 0 & AllC$TypeOfSite == "nonsyn") )])

AllG$graphit<-NA
for (i in 1:length(AllG$makesCpG)) {
  if (AllG$makesCpG[i] == 1 && AllG$TypeOfSite[i] == "nonsyn") {
    AllG$graphit[i] <- 2
  }
  if (AllG$makesCpG[i] == 0 && AllG$TypeOfSite[i] == "nonsyn") {
    AllG$graphit[i] <- 1
  }
}
AllG[(which(AllG$makesCpG == 1 & AllG$TypeOfSite == "nonsyn") ),11] <- mean(AllG$colMeansTsZanini[(which(AllG$makesCpG == 1 & AllG$TypeOfSite == "nonsyn") )])
AllG[(which(AllG$makesCpG == 0 & AllG$TypeOfSite == "nonsyn") ),11] <- mean(AllG$colMeansTsZanini[(which(AllG$makesCpG == 0 & AllG$TypeOfSite == "nonsyn") )])
...
p=AllA$colMeansTsZanini[AllA$makesCpG == 0 & AllA$TypeOfSite == "nonsyn"]
p1<-rep(1,length(p))
p1<-rnorm(n = length(p), mean = 1, sd = 0.15)
q=AllA$colMeansTsZanini[AllA$makesCpG == 1 & AllA$TypeOfSite == "nonsyn"] 
q1<-rnorm(n = length(q), mean = 2, sd = 0.15)
points(p1,p,col= alpha("#97CC04",1))
points(q1,q,col= alpha("#7E7ED1",1))

points(AllA$graphit[AllA$makesCpG == 0 & AllA$TypeOfSite == "nonsyn"],AllA$meanofmeans_value[AllA$makesCpG == 0 & AllA$TypeOfSite == "nonsyn"],col= factor(AllA$graphit),type="p", pch=19, cex = 3)
points(AllA$graphit[AllA$makesCpG == 1 & AllA$TypeOfSite == "nonsyn"],AllA$meanofmeans_value[AllA$makesCpG == 1 & AllA$TypeOfSite == "nonsyn"],col= factor(AllA$graphit),type="p", pch=19, cex = 3)



eaxis(2,at=c(10^-4,10^-3,10^-2,10^-1,10^0),cex.axis=1.1)
axis(1, at= c(1:4),labels = c("Non-CpG ", " CpG ", "Non-CpG-creating mutations \n Nonnonsyn", "CpG \n Nonnonsyn"), mgp=c(3, 1.5, 0))
...
r=AllT$colMeansTsZanini[AllT$makesCpG == 0 & AllT$TypeOfSite == "nonsyn"]
r1<-rnorm(n = length(r), mean = 1, sd = 0.15)
s=AllT$colMeansTsZanini[AllT$makesCpG == 1 & AllT$TypeOfSite == "nonsyn"] 
s1<-rnorm(n = length(s), mean = 2, sd = 0.15)
points(r1,r,col= alpha("#97CC04",1))
points(s1,s,col= alpha("#7E7ED1",1))

points(AllT$graphit[AllT$makesCpG == 0 & AllT$TypeOfSite == "nonsyn"],AllT$meanofmeans_value[AllT$makesCpG == 0 & AllT$TypeOfSite == "nonsyn"],col= factor(AllT$graphit),type="p", pch=19, cex = 3)
points(AllT$graphit[AllT$makesCpG == 1 & AllT$TypeOfSite == "nonsyn"],AllT$meanofmeans_value[AllT$makesCpG == 1 & AllT$TypeOfSite == "nonsyn"],col= factor(AllT$graphit),type="p", pch=19, cex = 3)

#plot all points used from mean function onto 1 & 2
#AllT$colMeansTsZanini[(which(AllT$makesCpG == 1 & AllT$TypeOfSite == "nonsyn") )] on 1
#AllT$colMeansTsZanini[(which(AllT$makesCpG == 0 & AllT$TypeOfSite == "nonsyn") )] on 2
...
# f=AllG$colMeansTsZanini[AllG$makesCpG == 0 & AllG$TypeOfSite == "nonsyn"]
# f1<-rnorm(n = length(f), mean = 1, sd = 0.15)
# g=AllG$colMeansTsZanini[AllG$makesCpG == 1 & AllG$TypeOfSite == "nonsyn"]
...
# q=AllC$colMeansTsZanini[AllC$makesCpG == 0 & AllC$TypeOfSite == "nonsyn"]
# q1<-rnorm(n = length(q), mean = 1, sd = 0.15)
# w=AllC$colMeansTsZanini[AllC$makesCpG == 1 & AllC$TypeOfSite == "nonsyn"]
